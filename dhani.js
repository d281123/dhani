...
• Gopay : _083112170548_
• Dana : _083112170548_
• Ovo : _083112170548_
• Pulsa : _083112170548_`
but = [
{ buttonId: `${prefix}menu`, buttonText: { displayText: 'ᴍᴇɴᴜ' }, type: 1 },
{ buttonId: `${prefix}owner`, buttonText: { displayText: 'ᴏᴡɴᴇʀ' }, type: 1 }
]
sendButImage(from, menunya, `*_${tanggal} - ${time} WIB_*`, but)
break
...
break
case 'public':
if (!mek.key.fromMe && !isOwner) return reply('Luh Siapa Sih Bang ?,Owner aja bukan')
